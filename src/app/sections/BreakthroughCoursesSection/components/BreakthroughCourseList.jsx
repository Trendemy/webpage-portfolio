...
import BreakthroughRegisterModal from '~/app/sections/BreakthroughCoursesSection/components/BreakthroughRegisterModal';
import { Button, Image } from '~/components/UI';

function BreakthroughCourseList({ courses }) {
